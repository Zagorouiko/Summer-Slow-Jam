...
public class JengaGameManager : MonoBehaviourPunCallbacks
{
    ...
    //public GameObject SimulatedPrefab;
    ...
    void Start()
    {
        ...
        {
            player1GO = PhotonNetwork.Instantiate(playerPrefab.name, new Vector3(1.252f, 0f, 5.225f), Quaternion.identity);
    ...
    //    player1ViewID = FindObjectOfType<PlayerSetup>().gameObject.GetComponent<PhotonView>();
    ...
    //    PhotonNetwork.Instantiate(SimulatedPrefab.name, new Vector3(0, 0, 0), Quaternion.identity);
    //    //PhotonNetwork.Instantiate(headPrefab.name, VRManager.instance.head.transform.position, VRManager.instance.head.transform.rotation, 0);
    //    //PhotonNetwork.Instantiate(leftHandPrefab.name, VRManager.instance.leftHand.transform.position, VRManager.instance.leftHand.transform.rotation, 0);
    //    //PhotonNetwork.Instantiate(rightHandPrefab.name, VRManager.instance.rightHand.transform.position, VRManager.instance.rightHand.transform.rotation, 0);
    ...
    private void Update()
    {
        Debug.Log(player1GO.GetComponent<PhotonView>().Owner.NickName);
